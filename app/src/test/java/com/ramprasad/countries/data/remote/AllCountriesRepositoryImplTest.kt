...
class AllCountriesRepositoryImplTest {
    ...
    @Test
    fun `getAllCountries emits loading and error when retrofit returns null body`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `getAllCountries emits loading and error when retrofit throws exception`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `getAllCountries emits loading and success with empty list response`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `getAllCountries emits loading and success with countries having empty names`() =
        runTest {
            // Arrange
            val countriesWithEmptyNames =
                listOf(
                    Countries(name = ""),
    ...
    @Test
    fun `getAllCountries emits loading and success with all same starting letter`() =
        runTest {
            // Arrange
            val countries =
                listOf(
    ...
    @Test
    fun `getAllCountries emits loading and success with mixed empty and valid names`() =
        runTest {
            // Arrange
            val countries =
                listOf(
